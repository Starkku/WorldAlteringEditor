...
public static class Helpers
{
    ...
    public static IEnumerable<Point2D> GetFillAreaTiles(MapTile targetTile, Map map, ITheater theater)
    {
        ITileImage tileGraphics = theater.GetTile(targetTile.TileIndex);
        ...
        while (tilesToCheck.First != null)
        {
            ...
            tileGraphics = theater.GetTile(cell.TileIndex);
