...
internal class MapFootPlacementProperties
{
    ...
    [Description("Initial mission. Valid values are Ambush, Area Guard, Attack, Capture, Construction, Enter, Guard, Harmless, " +
        "Harvest, Hunt, Missile, Move, Open, Patrol, QMove, Repair, Rescue, Retreat, Return, Sabotage, Selling, Sleep, Sticky, Stop, and Unload.")]
