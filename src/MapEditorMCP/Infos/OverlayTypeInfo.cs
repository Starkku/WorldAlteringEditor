...
internal class OverlayTypeInfo
{
    public OverlayTypeInfo(string iniName, string uiName, string editorCategory, int frameCount, bool tiberium, bool wall, bool waterBound,
...
internal class ConnectedOverlayFrameInfo
{
    public ConnectedOverlayFrameInfo(string overlayININame, int frameIndex, int connectsTo)
    {
...
internal class ConnectedOverlayTypeInfo
{
    public ConnectedOverlayTypeInfo(string name, string uiName, int connectionMask, List<string> relatedOverlayNames,
        List<ConnectedOverlayFrameInfo> frames)
    {
        Name = name;
        UIName = uiName;
    ...
    public List<ConnectedOverlayFrameInfo> Frames { get; }
}
