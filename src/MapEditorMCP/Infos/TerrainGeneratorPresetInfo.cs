...
internal sealed class TerrainGeneratorPresetSummary
{
    public TerrainGeneratorPresetSummary(
        string presetId,
        string name,
        string theater,
        bool isUserPreset,
    ...
    [Description("Whether the effective preset configuration can currently be generated safely. " +
        "Inspect unusable presets with get_terrain_generator_preset for validation errors.")]
...
internal class TerrainGeneratorChanceGroupInfo
{
    public TerrainGeneratorChanceGroupInfo(double openCellChance, double occupiedCellChance)
    {
...
internal sealed class TerrainGeneratorTerrainTypeGroupInfo : TerrainGeneratorChanceGroupInfo
{
    public TerrainGeneratorTerrainTypeGroupInfo(double openCellChance, double occupiedCellChance, List<string> terrainTypeNames)
...
internal sealed class TerrainGeneratorTileGroupInfo : TerrainGeneratorChanceGroupInfo
{
    public TerrainGeneratorTileGroupInfo(
...
internal sealed class TerrainGeneratorOverlayGroupInfo : TerrainGeneratorChanceGroupInfo
{
    public TerrainGeneratorOverlayGroupInfo(
        double openCellChance,
        double occupiedCellChance,
...
internal sealed class TerrainGeneratorSmudgeGroupInfo : TerrainGeneratorChanceGroupInfo
{
    public TerrainGeneratorSmudgeGroupInfo(double openCellChance, double occupiedCellChance, List<string> smudgeTypeNames)
        : base(openCellChance, occupiedCellChance)
    {
...
internal sealed class TerrainGeneratorPresetInfo
{
    public TerrainGeneratorPresetInfo(
        string presetId,
        string name,
        string theater,
        bool isUserPreset,
        List<string> validationErrors,
        List<TerrainGeneratorTerrainTypeGroupInfo> terrainTypeGroups,
        List<TerrainGeneratorTileGroupInfo> tileGroups,
        List<TerrainGeneratorOverlayGroupInfo> overlayGroups,
        List<TerrainGeneratorSmudgeGroupInfo> smudgeGroups)
    {
        PresetId = presetId;
        Name = name;
        Theater = theater;
    ...
    public List<TerrainGeneratorTerrainTypeGroupInfo> TerrainTypeGroups { get; }
    public List<TerrainGeneratorTileGroupInfo> TileGroups { get; }
    public List<TerrainGeneratorOverlayGroupInfo> OverlayGroups { get; }
    public List<TerrainGeneratorSmudgeGroupInfo> SmudgeGroups { get; }
}

internal sealed class TerrainGenerationResult
{
    ...
    [Description("Summary of the cells that could have changed, including full-tile footprints and possible AutoLAT neighbors. " +
        "Individual random placements can affect fewer cells.")]
