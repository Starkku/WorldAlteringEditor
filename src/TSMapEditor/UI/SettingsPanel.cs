...
public class SettingsPanel : INItializableWindow
{
    ...
    private XNACheckBox chkEnableMCPServer;
    private EditorNumberTextBox tbMCPServerPort;
    ...
    public override void Initialize()
    {
        ...
        chkEnableMCPServer = FindChild<XNACheckBox>(nameof(chkEnableMCPServer));
    ...
    private void LoadSettings()
    {
        ...
        chkEnableMCPServer.Checked = userSettings.EnableMCP;
        tbMCPServerPort.Value = userSettings.MCPServerPort;
    }

    public bool Validate()
    {
        int minimumPort = 0;
        int maximumPort = ushort.MaxValue;

        if (tbMCPServerPort.Value < minimumPort || tbMCPServerPort.Value >= maximumPort)
        {
            EditorMessageBox.Show(WindowManager, Translate(this, "InvalidMCPPort.Header", "Invalid MCP Port"), string.Format(Translate(this, "InvalidMCPPort.Description", "MCP port must be between {0} and {1}."), minimumPort, maximumPort), Windows.MessageBoxButtons.OK);
            return false;
        }
    ...
    public void ApplySettings()
    {
        ...
        UserSettings.Instance.EnableMCP.UserDefinedValue = chkEnableMCPServer.Checked;
        UserSettings.Instance.MCPServerPort.UserDefinedValue = tbMCPServerPort.Value;
    }
}
