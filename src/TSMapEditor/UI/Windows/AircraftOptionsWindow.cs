...
public class AircraftOptionsWindow : INItializableWindow
{
    ...
    public override void Initialize()
    {
        ...
        {
            throw new INIConfigException($"Invalid options specified for {nameof(ddVeterancy)} in {nameof(AircraftOptionsWindow)}. Options must start with a number followed by a space.");
        }
